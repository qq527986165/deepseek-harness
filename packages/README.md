...
| [`memory/`](memory/README.md) | Memory capability family: sole-provider seam, Obsidian-compatible file-first provider, and model-facing memory tools | Product — stable API |
