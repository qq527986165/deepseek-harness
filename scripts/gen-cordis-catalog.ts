...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  MemoryLinkKind: 'memory.md',
  MemoryLinkTarget: 'memory.md',
  MemoryNote: 'memory.md',
  MemoryNoteId: 'memory.md',
  MemoryPersona: 'memory.md',
  MemoryRecentNote: 'memory.md',
  MemoryRecentOptions: 'memory.md',
  MemoryDistillCommitGroupInput: 'memory.md',
  MemoryDistillCommitResult: 'memory.md',
  MemoryJournalAppendInput: 'memory.md',
  MemoryJournalAppendResult: 'memory.md',
  MemoryProvider: 'memory.md',
  MemoryScope: 'memory.md',
  MemorySearchHit: 'memory.md',
  MemorySearchOptions: 'memory.md',
  MemoryTraversal: 'memory.md',
  MemoryTraversalNode: 'memory.md',
  MemoryTraverseOptions: 'memory.md',
  MemoryWriteInput: 'memory.md',
  MemoryWriteResult: 'memory.md',
  MemoryListOptions: 'memory.md',
  MemoryListedNote: 'memory.md',
  MemoryListResult: 'memory.md',
  MemoryDeleteOptions: 'memory.md',
  MemoryDeleteResult: 'memory.md',
  MemoryInfo: 'memory.md',
